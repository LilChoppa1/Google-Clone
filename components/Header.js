...
function Header() {
    ...
    return (
        <header className="sticky top-0 bg-white">
            ...
            onClick={() => router.push('/')}
             />
             <form className="flex px-6 flex-grow py-3 ml-10 mr-5 border border-gray-200 rounded-full 
             ...
             <Avatar url="https://ih1.redbubble.net/image.1129225687.4831/flat,750x,075,f-pad,750x1000,f8f8f8.jpg"
                    className="ml-auto"
                    />
             </div>
             <HeaderOptions />
